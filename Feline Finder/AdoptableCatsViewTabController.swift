...
class AdoptableCatsTabViewController: ZoomAnimationViewController, UICollectionViewDelegate, UICollectionViewDataSource, CLLocationManagerDelegate { //, NavgationTransitionable {
